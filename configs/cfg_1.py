...
cfg.debug = True
cfg.logging = False
cfg.neptune_connection_mode = "offline"
cfg.comment = ""
...
cfg.class_weights_dict = {'flinch': 64.0,'sniffface': 36.57,'reciprocalsniff': 28.44,'attemptmount': 28.44,'chase': 25.6,
    'sniffbody': 25.6,'run': 24.38,'approach': 24.38,'escape': 22.26,'sniff': 20.48,'defend': 19.69,'exploreobject': 18.96,
    'sniffgenital': 18.96,'chaseattack': 18.62,'selfgroom': 16.52,'follow': 16.0,'tussle': 16.0,'dominancemount': 15.75,
    'huddle': 14.22,'attack': 14.22,'rear': 14.22,'disengage': 12.8,'avoid': 12.64,'biteobject': 12.49,'climb': 12.19,
    'submit': 11.64,'dig': 10.04,'mount': 8.46,'dominance': 7.88,'dominancegroom': 7.31,'genitalgroom': 5.79,
    'freeze': 4.74,'shepherd': 4.53,'allogroom': 4.49,'rest': 2.28,'intromit': 1.57, 'ejaculate': 1.0, 'no_action': 1.0}

cfg.class_weights = []
for action_name in cfg.set_behavior_classes:
    weight = cfg.class_weights_dict.get(action_name, 1.0)
    cfg.class_weights.append(weight)

# DATASET
cfg.dataset = "ds_hybrid"
...
cfg.awp_start_epoch = 20  # Epoch to start AWP (optional)

cfg.swa = True  # Enable Stochastic Weight Averaging
cfg.swa_eval = False  # Use SWA model for evaluation
cfg.swa_start = 55  # Epoch to start SWA
...
# AUGS
cfg.augment = True
cfg.aug_prob = 0.5  # Overall probability to apply any augmentation per sample
